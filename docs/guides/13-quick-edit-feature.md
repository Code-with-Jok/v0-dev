...
2. Nhấn nút **Quick Edit** (hoặc phím **Ctrl+i / ⌘I**) → form input mở ra
...
flowchart TD
    subgraph Client["🖥️ Client (Browser)"]
        ...
        subgraph QuickEditExt["Quick Edit Extension"]
            ...
            QEKeymap["keymap.ts<br/>Phím Mod-i"]
...
└── features/editor/extensions/
    ...
    └── quick-edit/                       # Quick Edit extension
        ...
        ├── keymap.ts                     # Phím tắt Mod-i (Ctrl+i / ⌘I)
...
sequenceDiagram
    ...
    User->>ST: Click "Quick Edit" hoặc nhấn Ctrl+i
...
| --------------- | ---------------- | ------------------ |
| `Ctrl+i` / `⌘I` | Có text selected | Mở Quick Edit form |
| `Ctrl+i` / `⌘I` | Không select     | Không làm gì       |
